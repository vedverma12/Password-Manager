...
const Manager = () => {
    ...
    const showPassword = () => {
        ...
        if (ref.current.src.includes("eye-close_1.png")) {
            passwordRef.current.type = "password"
            ref.current.src = "eye-open_2.png"
        }
        else {
            ref.current.src = "eye-close_1.png"
            passwordRef.current.type = "text"
        }
    }
    ...
    return (
        <>
            ...
            />
            <div className="fixed inset-0 -z-10 min-h-screen w-full bg-green-50 bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:14px_24px]"><div className="absolute left-0 right-0 top-0 -z-10 m-auto h-[310px] w-[310px] rounded-full bg-green-400 opacity-20 blur-[100px]"></div></div>
                    ...
                    <div className='flex flex-col md:flex-row w-full justify-between gap-2'>
                        ...
                        <div className="relative">
                            ...
                            <span className='absolute right-[3px] top-[4px] cursor-pointer ' onClick={showPassword} >
                                <img ref={ref} className='p-1' width={26} src="eye-open_2.png" alt="" />
                            </span>
                        </div>
                    </div>
                                ...
                                return <tr key={index}>
                                    <td className='py-2 border border-white text-center '>
                                        <div className='flex gap-1 justify-center items-center '>
                                            ...
                                            <span className='cursor-pointer w-3' onClick={() => { copyText(item.site) }}><img src="copy.svg" alt="" /></span>
                                        </div>
                                    </td>
                                    <td className='py-2 border border-white text-center '>
                                        <div className='flex gap-1 justify-center items-center '>{item.username}
                                            <span className='cursor-pointer w-3' onClick={() => { copyText(item.username) }}><img src="copy.svg" alt="" /></span>
                                        </div>
                                    </td>
                                    <td className='py-2 border border-white text-center '>
